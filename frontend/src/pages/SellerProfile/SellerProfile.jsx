...
const SellerProfile = () => {
  ...
  const getSeller = async () => {
    try {
      ...
      const response = await axios.get(`https://krishisevabackendnew-tfhz.onrender.com/api/v1/seller/${userId}`);
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.patch(`https://krishisevabackendnew-tfhz.onrender.com/api/v1/seller/${userId}`, {
        bank: userInfo.bank,
