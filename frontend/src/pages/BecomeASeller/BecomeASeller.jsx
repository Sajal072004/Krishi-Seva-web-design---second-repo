          ...
          <div className='mt-[20vh] flex'>
            ...
            <div className=' p-4'>
              ...
              <div className='bg-white p-6 rounded-lg shadow-md text-center'>
                <h3 className='text-xl font-semibold text-center'>Top Selling Items</h3>
                ...
                <button className='bg-green-500 py-2 px-6 w-full text-white rounded-lg mt-4 hover:bg-green-600'>View All</button>
              </div>
            </div>
          </div>
        </div>
