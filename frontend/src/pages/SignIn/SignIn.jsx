...
//   const [url, setUrl] = useState('https://krishisevabackendnew-tfhz.onrender.com/api/v1/user/signin');
...
//     try {
//       const response = await axios.post('https://krishisevabackendnew-tfhz.onrender.com/api/v1/user/forget', {
//         email
//       });
...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    toast.error('Backend not working. Login is disabled.');
  };

  const handleForgotPassword = () => {
    toast.error('Backend not working. Forgot password is disabled.');
  };
